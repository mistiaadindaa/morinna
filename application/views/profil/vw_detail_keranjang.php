    ...
    <h1 class="h3 mb-4 text-gray-800"><?php echo $judul; ?></h1>
        ...
        <div class="col-md-12">
            <table class="table">
                ...
                <tbody>
                    <form action="<?= base_url('Profil/pesanan');
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" name="bayar" value="<?= $total_bayar; ?>"><button type="submit" class="btn btn-primary"><i class="fa fa-save"></i>&nbsp;&nbsp;Pesan</button>
                            </td>
                        </tr>
                        </tr>
                        </div>
