...
<body class="animsition">
				...
				<nav class="limiter-menu-desktop container">
                    ...
                    <div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="<?= site_url('Profil/Hijab') ?>">Hijab</a>
							</li>
							<li>
								<a href="<?= site_url('Profil') ?>">Profile</a>
							</li>
						</ul>
					</div>	
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						<a class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 "  href="<?= base_url('Profil/detail') ?>">
							<i class="zmdi zmdi-shopping-cart" ></i>
                    </a>

						<a href="<?= base_url('Profil/pembelian') ?>"class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 " >
	...
	<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('http://localhost/Mistia_2TIE_UAS2/assets/img/hijab/sampul2.jpg');">
		<h2 class="ltext-105 cl0 txt-center">
			Product Morinna.Couture
		</h2>
	</section>	
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-primary shadow h-70 py-2">
                    ...
                    <div class="block2-pic hov-img0 text-center">
							<img src="<?= base_url('assets/img/hijab/') . $us['gambar']; ?>" style="height:300px; width:200px;"  class="img-thumbnail">

							<a href="<?= base_url('Profil/keranjang/') . $us['id'] ?>" class="block2-btn flex-c-m ">
								Shop
							</a>
						</div>
						<br>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="<?=base_url('assets/')?>images/product-detail-01.jpg">
									...
									<div class="item-slick3" data-thumb="<?=base_url('assets/')?>images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
									...
									<div class="item-slick3" data-thumb="<?=base_url('assets/')?>images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
