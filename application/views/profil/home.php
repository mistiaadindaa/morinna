...
<body class="animsition">
	...
	<header>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
					<img src="<?=base_url('assets/')?>img/profile/abu.png" alt="IMG-LOGO"></a>
			</div>
		...
		<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
			<div class="container-search-header">
				...
				<img src="<?=base_url('assets/')?>img/profile/abu.png" alt="CLOSE">
				</button>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(<?=base_url('assets/')?>img/hijab/morinna.couture.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="<?= site_url('Auth/login') ?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Shop Now
								</a>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="<?= site_url('Auth/login') ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
