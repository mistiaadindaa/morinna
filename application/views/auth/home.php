...
<body class="animsition">
	...
	<header>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						<a href="Auth" class="flex-c-m trans-04 p-lr-25">
                             Login Account
						</a>
					</div>
				</div>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<img src="<?=base_url('assets/')?>images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1" style="background-image: url(<?=base_url('assets/')?>img/home/sampull.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-70 p-b-20 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="<?= site_url('Auth') ?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
									Login
								</a>
							</div>
						</div>
				...
				<div class="item-slick1" style="background-image: url(<?=base_url('assets/')?>img/home/sampulll.png);">
					<div class="container h-full">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<?=base_url('assets/')?>img/hijab/morinna.couture2.jpg" alt="IMG-BANNER">

						<a href="<?= site_url('Auth') ?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?=base_url('assets/')?>img/hijab/sampull.jpeg" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?=base_url('assets/')?>img/hijab/sampul.jpeg" alt="IMG-BANNER">
